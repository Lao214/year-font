<template>
   <div class="body">
   <div class="container">
    <p class="flip-horizontal-top" >你喜欢在<a style="font-size: 2rem;color: rgb(255,215,0);">{{dataObj.time}}：00</a>用<a style="font-size: 2rem;color: rgb(255,215,0);">{{dataObj.device}}</a>登陆富学宝典平台开始学习。</p>
